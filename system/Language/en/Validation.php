...
return [
   ...
   'allowed_string'        => "{field} field does contain invalid characters.",
   'allowed_string_name'   => '{field} field does contain invalid characters for a name.',
   'required_if'           => '{field} field does match.',
   'disallow_dash'         => '{field} does not have a proper input.',
   'custom_valid_date'     => 'The {field} field must contain a valid date.',
   'valid_birthdate'       => 'The {field} field must not contain a future date.',
   'valid_nakakatanda'     => '{field} A - Nakatatanda must be 60 years old and above.',
   'valid_ina'             => '{field} B - Buntis or C - Nagpapasusong Ina must be female.',
   'valid_ina_age'         => '{field} B - Buntis or C - Nagpapasusong Ina must not below 8 years old.',
   'valid_relasyon_age'    => "Please check the age difference to the 'punong pamilya'.",
];
